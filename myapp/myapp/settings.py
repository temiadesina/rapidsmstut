...
# and README.rst, a myapp directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'myapp')
...
SECRET_KEY = 'nag+eghx$k7%_=tg-+k89#bl@6&g08wgmzs^*h*m_8@uw7q)b5'
...
RAPIDSMS_HANDLERS = (
    ...
    #'rapidsms.contrib.echo.handlers.ping.PingHandler',
     "tut.handlers.myhandlers.HelpHandler",
     "tut.handlers.myhandlers.SumHandler",
